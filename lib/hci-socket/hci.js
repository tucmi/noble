...
Hci.prototype.createLeConn = function(address, addressType) {
  ...
  cmd.writeUInt16LE(0x0040, 17); // min interval
  cmd.writeUInt16LE(0x0080, 19); // max interval
  cmd.writeUInt16LE(0x0032, 21); // latency
  cmd.writeUInt16LE(0x0c80, 23); // supervision timeout
